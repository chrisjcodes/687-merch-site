...
// Brand colors from portal theme
const plum  = '#732d6a';
const teal  = '#05cbc5'; 
const acid  = '#f1f42e';
const pink  = '#e862aa';
...
const marketingTheme = createTheme({
  palette: {
    ...
    primary: {
      main: '#1ca6a1',
      light: lighten('#1ca6a1', 0.2),
      dark: darken('#1ca6a1', 0.2),
    },
    secondary: {
      main: teal,
      light: lighten(teal, 0.2),
      dark: darken(teal, 0.2),
    },
    warning: {
      main: acid,
      light: lighten(acid, 0.2),
      dark: darken(acid, 0.2),
    },
    error: {
      main: pink,
      light: lighten(pink, 0.2),
    ...
    // Custom brand colors for use in components
    brand: {
      plum,
      teal, 
      acid,
    ...
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          boxShadow: 'none',
          '&:hover': {
            backgroundColor: darken('#1ca6a1', 0.1),
          },
        },
      },
    },
